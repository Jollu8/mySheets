...
//    topaste=nullptr;
    //spreadsheetname
    setWindowIcon(QIcon("../img/img_tools/xls.png"));
...
{
    // --------- New File -------------------
    QPixmap newIcon("../img/img_tools/new_file.png");
    newFile = new QAction(newIcon, "&New", this);
    newFile->setShortcut(tr("Ctrl+N"));


    // --------- open file -------------------
    QPixmap openIcon("../img/img_tools/open_file.png");
    open = new QAction(openIcon, "&Open", this);
    open->setShortcut(tr("Ctrl+O"));

    // --------- save file -------------------
    QPixmap SaveIcon("../img/img_tools/save_file.png");
    ...
    // --------- cut file -------------------
    QPixmap cutIcon("../img/img_tools/cut_icon.png");
    cut = new QAction(cutIcon, "&Cut", this);
    cut->setShortcut(tr("Ctrl+X"));

    // --------- copy menu -----------------
    QPixmap CopyIcon("../img/img_tools/Copy_file.png");
    copy = new QAction(CopyIcon, "&Copy", this);
    copy->setShortcut(tr("Ctrl+C"));

    // --------- paste menu -----------------
    QPixmap PasteIcon("../img/img_tools/Paste_file.png");
    paste = new QAction(PasteIcon, "&Paste", this);
    paste->setShortcut(tr("Ctrl+V"));

    // --------- delete menu -----------------
    QPixmap DeleteIcon("../img/img_tools/Delete_file.png");
    ...
    // --------- find menu -----------------
    QPixmap findIcon("../img/img_tools/search_icon.png");
    find= new QAction(findIcon, "&Find", this);
    find->setShortcut(tr("Ctrl+F"));

    // --------- goCell menu -----------------
    QPixmap goCellIcon("../img/img_tools/go_to_icon.png");
    ...
    QPixmap AboutIcon("../img/img_tools/About.png");
    ...
    // --------- exit -------------------
    QPixmap exitIcon("../img/img_tools/quit_icon.png");
...
void SpreadSheet::saveContent(const QString& filename)
{
    QFile file(filename);
...
void SpreadSheet::loadContent(const QString& filename)
{
...
{
    QFileDialog d;
    auto filen = QFileDialog::getOpenFileName();
